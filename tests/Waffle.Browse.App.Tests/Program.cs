...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Native shell click requests selection sync", NativeShellSelectionGestureTrackerTests.ClickRequestsSelectionSync),
    ("Native shell drag skips selection sync", NativeShellSelectionGestureTrackerTests.DragSkipsSelectionSync),
    ("Native shell cross-panel release skips selection sync", NativeShellSelectionGestureTrackerTests.ReleaseInAnotherPanelSkipsSelectionSync),
