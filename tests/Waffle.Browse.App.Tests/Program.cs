...
var tests = new (string Name, Action Run)[]
{
    ...
    ("NativeAOT helper requires a structured PE and no managed sidecars", NativeAotIndexerImagePolicyTests.RequiresStructuredPeAndRejectsManagedSidecars),
    ("NativeAOT helper stamp is accepted only at trusted PE boundaries", NativeAotIndexerImagePolicyTests.AcceptsOnlyExactStampBoundaries),
    ("NativeAOT helper launch lease blocks image mutation", NativeAotIndexerImagePolicyTests.VerifiedImageLeaseBlocksMutationUntilLaunchCompletes),
    ("NativeAOT helper rejects managed bundles and managed PE headers", NativeAotIndexerImagePolicyTests.RejectsManagedBundlesAndManagedPeHeaders),
    ("NativeAOT helper PE parser fails closed at every truncation", NativeAotIndexerImagePolicyTests.PeParserFailsClosedAtEveryTruncation),
    ("NativeAOT helper marker stays out of Core in both encodings", NativeAotIndexerImagePolicyTests.MarkerIsExcludedFromCoreAssembly),
