...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Waffle global search location is rejected", WaffleSearchLocationTests.GlobalLocationIsRejected),
    ...
    ("Recursive index stays within reparse-point boundaries", RecursiveFileIndexSourceTests.IndexesAccessibleFilesWithoutFollowingReparsePoints),
    ...
    ("Lazy provider indexes only the selected folder", WaffleFileSearchProviderTests.LazyProviderIndexesOnlySelectedFolder),
};
